...
const AddProduct = () => {
  ...
  const handleYesNoClick = (name, value) => {
    setProductData((prev) => ({
      ...prev,
      [name]: value === "true" ? 1 : 0, // Convert the value to 1 for Yes and 0 for No
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    // List of fields to be converted to integers (1 for true, 0 for false)
    const booleanFields = [
      "is_recyclable",
      "is_biodegradable",
      "is_reusable",
    ...
    return (
      ...
      <div className="p-6 md:p-10 bg-[#F3F6F4] min-h-screen">
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
          <h2 className="text-3xl font-bold text-[#1F2421]">
            🎉 Product Added Successfully!
          </h2>
          <div className="space-y-6">
            <p className="text-lg font-medium">
              Your product has been successfully added. Here are the details:
            </p>
            <div className="space-y-4">
              ...
              <div>
                <strong>Short Description of Product:</strong>{" "}
                {productData.short_description}
              </div>
              <div>
                <strong>Durability:</strong> {productData.durability}
              </div>
              <div>
              ...
              <div>
                ...
                {productData.is_recyclable === "true" ? "Yes" : "No"}
              </div>
              <div>
                <strong>Biodegradable:</strong>{" "}
                {productData.is_biodegradable === "true" ? "Yes" : "No"}
              </div>
              <div>
                <strong>Reusable:</strong>{" "}
                {productData.is_reusable === "true" ? "Yes" : "No"}
              </div>
              <div>
                <strong>Uses Organic Materials:</strong>{" "}
                {productData.uses_organic_materials === "true" ? "Yes" : "No"}
              </div>
              <div>
                <strong>Plastic Packaging:</strong>{" "}
                {productData.is_plastic_packaging === "true" ? "Yes" : "No"}
              </div>
              <div>
                <strong>Certified:</strong>{" "}
                {productData.is_certified === "true" ? "Yes" : "No"}
              </div>
                  ...
                  <div className="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-300 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-200 p-6 text-center cursor-pointer">
                    ...
                    >
                      <svg
                        ...
                        className="h-10 w-10 text-[#216869] mb-2"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                      ...
                      <span className="text-sm text-gray-600">
                        Click or drag images to upload (Max: 10 files)
                      </span>
              ...
              <div>
                ...
                <div className="flex flex-col items-center justify-center w-full border-2 border-dashed border-gray-300 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all duration-200 p-6 text-center cursor-pointer">
                  ...
                  >
                    ...
                    <span className="text-sm text-gray-600">
                      Click or drag certification image to upload
                    </span>
                    <span className="text-xs text-gray-400 mt-1">
                      Accepted formats: JPG, PNG, WEBP
                    </span>
